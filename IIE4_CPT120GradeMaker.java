...
public class CPT120GradeMaker {
	...
	public static void main(String[] args) {
		...
		processAnother= Integer.parseInt(JOptionPane.showInputDialog("Enter 1 to continue or any number to Stop")); 
		}
	}
	}
...
public static void main51(String[] args) {
	...
	// float has not been used here float data type is a single-precision 32-bit
	// IEEE 754 floating point, this data type should never be used for precise values,
	int numOfTimes = Integer.parseInt(JOptionPane.showInputDialog("How many Times?")); 
	int i=0;
	while (i < numOfTimes) 
	{ i = i + 1; 
	
	double enteredValue= Double.parseDouble(JOptionPane.showInputDialog("Enter a value for"+ i));
	//numOfTimes= Integer.parseInt(JOptionPane.showInputDialog("Enter a Number " + i));
